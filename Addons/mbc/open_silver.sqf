...
_legend_w_group = ["m107_DZ","BAF_LRR_scoped","M110_NVG_EP1","BAF_L85A2_RIS_CWS"];
...
_randtwo = random(2000) + random(2000);
_randtree = _randtwo + random(6000);
...
MBC_REWARDLIST = [
	...
	,["magazine","ItemGoldBar10oz",4,2,4]
	,["magazine","PartPlywoodPack",7,2,5]
	,["magazine","PartPlankPack",7,2,5]
	,["coins","Coins",random(2000),2,3]
	
	,["group_wep",_rare_weapons_group,1,3,5]
	,["group_mag",_rares_group,1,3,5]
	,["magazine","ItemGoldBar10oz",8,3,3]
	,["magazine","CinderBlocks",8,3,2]
	,["magazine","PartPlywoodPack",14,3,2]
	,["magazine","PartPlankPack",14,3,3]
	,["magazine","ItemPole",10,3,2]
	...
	,["magazine","ItemSilvercase_Base",1,4,1]
	,["magazine","CinderBlocks",14,4,1]
...
if (_finished) then {
	...
	cutText [format["Voce abriu a maleta de Bronze",MBT_NAME],"PLAIN DOWN"];
