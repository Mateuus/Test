if (!isDedicated) then {
	...
	player_zombieAttack = 			compile preprocessFileLineNumbers "custom\walkers\player_zombieAttack.sqf";
	...
	player_spawnCheck = 			compile preprocessFileLineNumbers "custom\walkers\player_spawnCheck.sqf";
	...
	player_disableSide = 			compile preprocessFileLineNumbers "dayz_code\compile\player_disableSide.sqf";;
	...
	player_craftItem =			compile preprocessFileLineNumbers "custom\ores.sqf";
        ...
        while { _timeOut < 12000 } do {
            ...
            if (!isNil "_display") then {
                if ( isNull _display ) then {
                 ...
                 _control1 ctrlSetText format["Chernobyl info: %1 & %2.",Zupa_LoadingMessage select 0 ,dayz_loadScreenMsg];             
	...
	// object_vehicleKilled =		compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\object_vehicleKilled.sqf";
	...
	// object_cargoCheck =			compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\object_cargoCheck.sqf";
	...
	//fnc_vehicleEventHandler = 		compile preprocessFileLineNumbers "\z\addons\dayz_code\init\vehicle_init.sqf";
	...
	//player_weaponCheck =			compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\player_weaponCheck.sqf";
	...
	fnc_updateCounter = {
		...
		(_dialog displayCtrl 1019) ctrlSetText format["Pontos Sobrando = %1",points];
	};
